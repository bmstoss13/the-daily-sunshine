...
func (q *Queries) SelectPostsOfTheDay(ctx context.Context, arg SelectPostsOfTheDayParams) ([]SelectPostsOfTheDayRow, error) {
	rows, err := q.db.Query(ctx, selectPostsOfTheDay, arg.CreatedAt, arg.CreatedAt_2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
